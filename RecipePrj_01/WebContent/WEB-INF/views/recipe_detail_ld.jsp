...
<link href="./resources/css/recipe_detail_ld.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="./resources/css/recipe_detail_min_ld.css" media="all" /> 
<link rel="stylesheet" type="text/css" href="./resources/css/recipe_detail_style_ld.css" media="all" />
	...
	<div class="container">
		...
		<div class="report-content">
		      <div class="report-header">
		        <h4 class="report-title">Recipe Title_제목</h4>
		...
		<!-- ------------------- 신고작성 디테일---------------------  -->
			...
			<h1 class="display-3">Recipe Title_제목</h1>
