...
function fileUpload(fis) {
    ...
    $('#recipe_thumbnail').text(fis.value.substring(str.lastIndexOf("\\")+1));
...
<app-root>
  ...
  <form class="writeForm" action="update_recipe" method="post" enctype="multipart/form-data">
  <!-- Page Content -->
  ...
  <input type="hidden" name="recipe_no" id="recipe_no" value="${update.recipe_no}" readonly="readonly">  
			...
			<div class="cont_box pad_l_60">
				...
				<div id="divMainPhotoUpload" class="cont_pic2">
					...
					<div id="divMainPhotoBox" is_over="0">
						...
						<img id="write_photo" onclick="document.getElementById('file').click();" src="${pageContext.request.contextPath}/resources/image/recipe_upload/${update.recipe_thumbnail}" style=" cursor: pointer;">
						<input type="hidden" name="recipe_thumbnail" id="recipe_thumbnail" value="${update.recipe_thumbnail}">
					</div> 
				...
				<div class="cont_line">
					...
					<input type="text" name="recipe_title" class="cok_title" id="recipe_title"
						class="form-control" value="${update.recipe_title}">
				</div>
				...
				<div class="cont_line pad_b_25">
					...
					<textarea name="recipe_content" id="recipe_content"
						...
						placeholder="예) 집에서 쉽게 만드는 뽀모도로 파스타 레시피 입니다" style=" resize: none;">${update.recipe_content}</textarea>
				</div>
				...
				<div class="cont_line pad_b_25">
					...
					<input type="hidden" name="del_video_photo" id="del_video_photo" value="1"> <input type="hidden"
						...
						style=" resize: none;">${update.recipe_video}</textarea>
							...
							<li id="liMaterialGroup_1">
								...
								<ul id="divMaterialArea_1" class="ui-sortable">
									...
									<a href="#" class="btn-lineup ui-sortable-handle" data-original-title="" title=""></a>
										<input type="text" name="mate_name" id="mate_name" class="form-control" style="width: 330px;" placeholder="예) 돼지고기" value="${update.mate_name}">
										<input type="text" name="mate_cnt" id="mate_cnt" class="form-control" style="width: 280px;" placeholder="예) 300g" value="${update.mate_cnt}">
						...
						<hr>	
							...
							<li id="recipeGroup_1">
								...
								<ul id="divRecipeArea_1" class="ui-sortable">
									...
									<a href="#" class="btn-lineup ui-sortable-handle" data-original-title="" title=""></a>
										<input type="text" name="step" id="step" class="form-control" style="width: 650px; height: 150px;" placeholder="step1 &nbsp; &nbsp; 예) 베이컨을 얇게 썰어주세요" value="${update.step}">										
										<a id="btnMaterialDel_1_1" href="javascript:delMaterial(1,1)" class="btn-del" style="display: none;"></a>
									</li>
